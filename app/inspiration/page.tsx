...
export default function InspirationPage() {
  return (
    <main>
      ...
      <Header />
      <span id="journee-ideale" aria-hidden="true" />
      <section className="subpage-hero">
        <HeroBackground src={siteMedia.destination.marsh} />
        <div className="subpage-overlay" />
        <div className="subpage-copy">
          <p className="eyebrow light">Mode Inspiration</p>
          <h1>Et si le séjour se composait autour de vous ?</h1>
          <p>
            Quelques envies suffisent. Nous réunissons la maison, les expériences, les bonnes
            adresses et un premier itinéraire.
          </p>
        </div>
      </section>
      <nav className="inspiration-navigation" aria-label="Explorer l’inspiration">
        <a href="#explorer">Explorer les îles</a>
        <a href="#gouter">Goûter</a>
        <a href="#respirer">Respirer</a>
        <a href="#dormir">Dormir</a>
        <a href="#decouvrir">Découvrir</a>
      </nav>
      <section
        id="explorer"
        className="inspiration-immersive"
        aria-label="Trois invitations au voyage"
      >
        {[
          {
          ...
          },
          {
            ...
            alt: "Pointe de Chassiron sur l’Île d’Oléron",
            eyebrow: "Regarder",
          ...
          <article className="inspiration-immersive__scene" key={scene.title}>
            ...
            <a
              className="inspiration-immersive__credit"
              href={scene.source}
              target="_blank"
              rel="noreferrer"
            >
      ...
      <section id="respirer" className="inspiration-manifesto shell">
        <p className="eyebrow">Respirer</p>
        <h2>Les paysages qui nous font ralentir.</h2>
        <p>
          Des marais au petit matin, une forêt qui filtre le vent, le sable encore frais et le
          pertuis qui change de couleur. Ici, le programme commence par de la place laissée au
          hasard.
        </p>
      </section>
      <section id="gouter" className="inspiration-editorial">
        <Image
          src="/images/destination/experiences/gouter-apres-midi-beaux-rivages.webp"
          alt="Goûter de l’après-midi avec gâteau, madeleines, fruits, caramels, jus et boissons chaudes"
          fill
          sizes="(max-width: 900px) 100vw, 55vw"
        />
        <div>
          <p className="eyebrow light">Goûter</p>
          <h2>Une journée idéale.</h2>
          <ol>
            <li>
              <span>08:30</span> Le marché avant l’effervescence
            </li>
            <li>
              <span>12:30</span> Un déjeuner improvisé à la maison
            </li>
            <li>
              <span>17:00</span> La plage choisie selon le vent
            </li>
            <li>
              <span>21:15</span> Le dernier rayon sur l’océan
            </li>
          </ol>
          <Link href="/conciergerie">Composer la vôtre →</Link>
        </div>
      </section>
      <section id="decouvrir" className="inspiration-host shell">
        <div>
          <p className="eyebrow">Découvrir</p>
          <h2>Le conseil de Stéphanie & Bruno.</h2>
          <blockquote>
        ...
        <Image
          ...
          alt="Pique-nique élégant au bord de l’océan"
          width={760}
          height={920}
        />
      </section>
      <section className="inspiration-seasons">
        <div>
          <p className="eyebrow light">Revenir</p>
          <h2>Nos maisons vivent au rythme des saisons.</h2>
          <p>
            La lumière franche de l’hiver, les pistes calmes du printemps, les longues soirées d’été
            ou les marchés d’automne : aucun séjour ne ressemble tout à fait au précédent.
          </p>
          <Link href="/saisons">Choisir sa saison →</Link>
        </div>
      </section>
      <section id="dormir" className="inspiration-section shell">
        <InspirationQuiz />
      </section>
      <Footer />
    </main>
