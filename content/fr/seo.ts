...
export type PageSchemaType = "WebSite" | "Organization" | "WebPage" | "CollectionPage";
...
export const staticPageSeo = {
  ...
  "/avis": {
    ...
    description:
      "Découvrez ce que les voyageurs apprécient au Chai des Tortues, à la Villa Raie Manta et au Nid d’Été.",
    path: "/avis",
    breadcrumbs: [home, { name: "Avis voyageurs", path: "/avis" }],
    schemaTypes: ["CollectionPage"],
  },
  "/livre-d-or": {
    title: "Livre d’Or des voyageurs | Beaux Rivages",
    description:
      "Découvrez les souvenirs manuscrits laissés par les voyageurs dans les maisons Beaux Rivages, retranscrits fidèlement et publiés après validation.",
    path: "/livre-d-or",
    breadcrumbs: [home, { name: "Livre d’Or", path: "/livre-d-or" }],
    schemaTypes: ["CollectionPage"],
  },
  "/carnet": {
  ...
  "/choisir": {
    ...
    description:
      "Comparez les maisons Beaux Rivages selon votre séjour : couple, famille, vélo, télétravail, accès plage ou vue mer.",
    path: "/choisir",
  ...
  "/construisez-votre-sejour": {
    ...
    description:
      "Créez un séjour personnalisé selon vos voyageurs et vos envies : gastronomie, vélo, plages, patrimoine, nature ou sports nautiques.",
  ...
  "/avant-arrivee": {
    ...
    description:
      "Checklist, météo intelligente, marées, marchés, restaurants et carte interactive pour préparer votre arrivée chez Beaux Rivages.",
    path: "/avant-arrivee",
  ...
  "/conseils": {
    ...
    description:
      "Bonnes adresses, producteurs, restaurants, balades et astuces personnelles de Stéphanie et Bruno sur les îles de Ré et d’Oléron.",
    path: "/conseils",
  ...
  "/mot-de-stephanie": {
    ...
    description:
      "La lettre de Stéphanie, l’histoire familiale et la philosophie d’accueil qui donnent vie aux maisons Beaux Rivages.",
  ...
  "/inspiration": {
    ...
    description:
      "Trouvez votre maison idéale, vos expériences et vos bonnes adresses selon votre façon de voyager et vos envies.",
    path: "/inspiration",
  ...
  "/sejour": {
    ...
    description:
      "Découvrez l’accompagnement Beaux Rivages avant, pendant et après votre séjour sur Ré ou Oléron.",
    path: "/sejour",
  ...
  "/saisons": {
    ...
    description:
      "Printemps, été, automne, Noël, hiver ou Pâques : découvrez comment les maisons et les îles vivent au fil des saisons.",
    path: "/saisons",
  ...
  "/faq": {
    ...
    description:
      "Réponses sur les maisons, destinations, réservations, animaux, enfants, vélos et plages.",
    path: "/faq",
  ...
  "/pourquoi-beaux-rivages": {
    ...
    description:
      "Découvrez la philosophie, l’histoire familiale, les valeurs et les engagements qui façonnent l’hospitalité Beaux Rivages.",
  ...
  "/carnet-voyageur": {
    ...
    description:
      "L’accompagnement Beaux Rivages avant, pendant et après votre séjour sur les îles.",
  ...
  "/destinations": {
    ...
    description:
      "Explorez l’Île de Ré, l’Île d’Oléron et les escapades choisies par Beaux Rivages.",
    path: "/destinations",
  ...
  "/engagements": {
    ...
    description:
      "Les engagements d’hospitalité, de transparence et de respect des îles de Beaux Rivages.",
    path: "/engagements",
  ...
  "/experiences": {
    ...
    description:
      "Découvrez 12 expériences Beaux Rivages : romance, gastronomie, vélo, bien-être, famille et attentions personnalisées sur Ré et Oléron.",
    path: "/experiences",
  ...
  "/personnaliser": {
    ...
    description:
      "Composez les attentions et options qui rendront votre séjour Beaux Rivages personnel.",
    path: "/personnaliser",
  ...
  "/phototheque": {
    ...
    description:
      "Explorez la photothèque immersive Beaux Rivages : extérieurs, chambres, cuisines, détails, instants de vie et destinations.",
    path: "/phototheque",
  ...
  "/pourquoi-revenir": {
    ...
    description:
      "Les maisons, les îles et les attentions qui donnent envie de retrouver Beaux Rivages.",
  ...
  "/reserver": {
    ...
    description:
      "Imaginez votre séjour Beaux Rivages : maison, dates, voyageurs et attentions personnalisées sur les îles.",
    path: "/reserver",
