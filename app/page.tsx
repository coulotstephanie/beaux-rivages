...
export async function generateMetadata() {
  ...
  const seo = localizeDeep(locale, pageSeo);
    ...
    <main>
      ...
      <Section className="home-islands" tone="sand">
        ...
        <div className="home-islands__grid">
          <Link
            href={localizedHref(locale, "/destinations/ile-de-re")}
          ...
          <Link
            href={localizedHref(locale, "/destinations/ile-d-oleron")}
      ...
      <Section id="experiences" tone="dark" className="moments-section">
        ...
        <div className="moments-grid">
          {localizedMoments.map((moment) => (
            <Link
              href={localizedHref(locale, moment.href)}
        ...
        <Button href={localizedHref(locale, "/experiences")} variant="secondary">
      ...
      <Section className="home-reviews" tone="sand">
        ...
        <div className="home-reviews__copy">
          ...
          <Button href={localizedHref(locale, "/avis")} variant="ghost">
      ...
      <Section className="premium-closing">
        <Heading
          ...
          align="center"
        />
        <Button href={localizedHref(locale, "/reserver")}>{t("Préparer votre séjour")}</Button>
      </Section>
