          ...
          data={[
            {
              ...
              name: "Beaux Rivages",
              alternateName: "Beaux Rivages — Île de Ré et Île d’Oléron",
              description:
                "Trois maisons de vacances à Rivedoux-Plage et Saint-Georges-d’Oléron, accueillies par Stéphanie et Bruno.",
              url: SITE_URL,
            ...
            },
            {
              ...
              "@id": `${SITE_URL}#brand`,
              name: "Beaux Rivages",
              alternateName: "Beaux Rivages — Ré et Oléron",
              slogan: "Trois maisons. Deux îles. Une même passion de l’hospitalité.",
              url: SITE_URL,
              logo: `${SITE_URL}/icon-192.png`,
            },
            {
