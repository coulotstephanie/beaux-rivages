...
export const stayOptions: StayOption[] = [
  { id: "signature", label: "Pack Signature Beaux Rivages", description: "Lits préparés, serviettes plage, deux peignoirs, panier et attention personnalisée.", price: 145 },
  { id: "linen", label: "Linge complet", description: "Draps et linge de toilette pour voyager léger.", price: 20, unit: "par voyageur" },
  { id: "beach-towels", label: "Serviettes de plage", description: "Une serviette par voyageur pour les journées au bord de l’océan.", price: 8, unit: "par voyageur" },
  { id: "robes", label: "Peignoirs", description: "Deux peignoirs doux préparés dans la maison.", price: 24 },
  { id: "slippers", label: "Chaussons", description: "Des chaussons de bain pour votre séjour.", price: 12 },
...
export const bookingExperiences: BookingExperienceOption[] = [
  { id: "romance", label: "Escapade romantique", description: "Pétales, lumière douce et deux flûtes préparées dans la chambre.", price: 75, duration: "À l’arrivée", propertySlugs: ["villa-raie-manta"] },
  { id: "anniversaire", label: "Anniversaire sur mesure", description: "Ballons, banderole et décoration accordée à l’âge et aux goûts.", price: 85, duration: "À l’arrivée" },
  { id: "lune-de-miel", label: "Lune de miel", description: "Champagne, pétales et attentions délicates dans l’intimité du Chai.", price: 110, duration: "Une soirée", propertySlugs: ["chai-des-tortues"] },
  { id: "fruits-de-mer", label: "Plateau de fruits de mer", description: "Une sélection de l’Atlantique prête à partager à la maison.", price: 95, duration: "Une soirée" },
  { id: "velo", label: "Échappée à vélo", description: "Itinéraire conseillé et vélos préparés selon disponibilité.", price: 60, duration: "Une journée" },
  { id: "famille", label: "Parenthèse en famille", description: "Jeux, petite surprise enfant et idées adaptées à la météo.", price: 45, duration: "Tout le séjour" },
];
...
export function getNights(arrival: string | null, departure: string | null) {
  ...
  return Math.max(0, Math.round((new Date(`${departure}T12:00:00`).getTime() - new Date(`${arrival}T12:00:00`).getTime()) / 86_400_000));
}
...
export function getBookingSuggestions(selection: BookingSelection) {
  ...
  if (selection.attention === "Anniversaire" || selection.attention === "Anniversaire de mariage") suggestions.push("anniversaire");
