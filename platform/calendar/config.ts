...
const sourceDefinitions: { propertySlug: PropertySlug; provider: CalendarProvider; env: string }[] = [
  { propertySlug: "chai-des-tortues", provider: "airbnb", env: "ICAL_CHAI_DES_TORTUES_AIRBNB_URL" },
  { propertySlug: "chai-des-tortues", provider: "booking", env: "ICAL_CHAI_DES_TORTUES_BOOKING_URL" },
  { propertySlug: "chai-des-tortues", provider: "abritel", env: "ICAL_CHAI_DES_TORTUES_ABRITEL_URL" },
  { propertySlug: "chai-des-tortues", provider: "google", env: "ICAL_CHAI_DES_TORTUES_GOOGLE_URL" },
  { propertySlug: "villa-raie-manta", provider: "airbnb", env: "ICAL_VILLA_RAIE_MANTA_AIRBNB_URL" },
  { propertySlug: "villa-raie-manta", provider: "booking", env: "ICAL_VILLA_RAIE_MANTA_BOOKING_URL" },
  { propertySlug: "villa-raie-manta", provider: "abritel", env: "ICAL_VILLA_RAIE_MANTA_ABRITEL_URL" },
  { propertySlug: "villa-raie-manta", provider: "google", env: "ICAL_VILLA_RAIE_MANTA_GOOGLE_URL" },
